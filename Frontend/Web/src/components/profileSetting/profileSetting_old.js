                    ...
                    <div className="container">
                            ...
                            <div className="landlordInfo d-flex justify-content-between align-items-center">
                                ...
                                <div className="signRight d-flex flex-wrap align-items-center">
                                    <div className="signature d-flex align-items-center">
                                        <span>Signature</span>
                                        <label>{this.state.profile.first_name + ' ' + this.state.profile.last_name}</label>
                                    </div>
                        ...
                        <div className="profileSettingTab mainTab">
                            <ul className="nav nav-tabs" role="tablist">
                                ...
                                <li className="nav-item" role="presentation">
                                    <a className="nav-link" id="address-tab" data-toggle="tab" href="#address" role="tab" aria-controls="started" aria-selected="false" onClick={() => this.getListOfPremiseAddress()}>Manage Premise Addresses</a>
                                </li>
                                <li className="nav-item" role="presentation">
